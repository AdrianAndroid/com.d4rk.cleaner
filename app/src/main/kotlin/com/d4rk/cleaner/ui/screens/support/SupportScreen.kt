...
fun SupportComposable(viewModel : SupportViewModel , activity : SupportActivity) {
    ...
    LargeTopAppBarWithScaffold(title = stringResource(id = com.d4rk.cleaner.R.string.support_us) , onBackClicked = { activity.finish() }) { paddingValues ->
        Box(
            modifier = Modifier
            ...
            LazyColumn {
                item {
                    Text(
                        text = stringResource(id = com.d4rk.cleaner.R.string.paid_support) ,
                ...
                item {
                    OutlinedCard(
                        ...
                        Column {
                            Text(
                                text = stringResource(id = com.d4rk.cleaner.R.string.summary_donations) , modifier = Modifier.padding(16.dp)
                            )
                            LazyRow(
                                modifier = Modifier
                                        .fillMaxWidth()
                ...
                item {
                    Text(
                        text = stringResource(id = com.d4rk.cleaner.R.string.non_paid_support) ,
                ...
                item {
                    FilledTonalButton(
                        ...
                        ButtonIconSpacer()
                        Text(text = stringResource(id = com.d4rk.cleaner.R.string.web_ad))
                    }
                }
                item {
