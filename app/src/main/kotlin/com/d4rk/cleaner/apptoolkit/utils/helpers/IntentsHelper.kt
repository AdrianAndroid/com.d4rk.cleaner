package com.d4rk.cleaner.apptoolkit.utils.helpers
...
object IntentsHelper {
    ...
    fun sendEmailToDeveloper(context : Context , @StringRes applicationNameRes : Int) {
        ...
        val body : String = context.getString(
            com.d4rk.cleaner.R.string.dear_developer
        ) + "\n\n"
        ...
        context.startActivity(
            Intent.createChooser(
                emailIntent , context.getString(com.d4rk.cleaner.R.string.send_email_using)
            )
        )
    }
