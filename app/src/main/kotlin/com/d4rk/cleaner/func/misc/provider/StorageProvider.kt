...
import com.d4rk.cleaner.func.misc.provider.EXTERNAL_STORAGE
import com.d4rk.cleaner.func.misc.provider.INTERNAL_STORAGE
import com.d4rk.cleaner.func.misc.provider.ROOT
import java.io.File
...
//        storageDeviceHolders.add(getRoot(context))
    ...
    private fun getRoot(context: Context): StorageDeviceHolder {
    ...
    fun getRecentFiles(
        ...
        val contentResolver: ContentResolver = globalClass.contentResolver
        val showHiddenFiles = true // globalClass.preferencesManager.displayPrefs.showHiddenFiles
